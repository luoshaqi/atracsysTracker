...
# while True:    
    ...
    data = {'timestamp':time.time(),
            ...
            'found_marker_rotation':[found_marker_rotation]}
...
df.to_pickle('~/Atracsys/fusionTrack_SDK-v4.7.4-linux64/python/scripts/data11.pkl')
df.to_csv('~/Atracsys/fusionTrack_SDK-v4.7.4-linux64/python/scripts/data11.csv',index=False)
